...
public class ShopFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.shop_fragment_item, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        mChart = (BarChart) view.findViewById(R.id.barchart_cb);
        ...
        leftAxis.setTypeface(MONOSPACE);
        ...
        rightAxis.setTypeface(MONOSPACE);
    ...
    private void setData(int count, float range) {
        ...
        if (mChart.getData() != null &&
            ...
            data.setValueTypeface(MONOSPACE);
